...
const SignInScreen = () => {
  ...
  const handleSignIn = () => {
    // Demo: accept anything, go to main app
  ...
  return (
    ...
    >
      ...
      <View style={[styles.form, shadows.card]}>
        ...
        <TouchableOpacity style={[styles.signInBtn, shadows.soft]} onPress={handleSignIn}>
        ...
        <TouchableOpacity style={styles.socialBtn} onPress={handleSignIn}>
          <MaterialIcons name="account-circle" size={20} color={colors.warmBrown} />
...
const styles = StyleSheet.create({
  ...
  title: { ...typography.h1, fontSize: 28, color: colors.warmBrown, marginTop: spacing.sm },
  subtitle: { ...typography.bodyMd, color: colors.onSurfaceVariant, fontStyle: 'italic' },
  ...
  label: { ...typography.labelCaps, color: colors.onSurfaceVariant, fontSize: 11 },
  inputWrap: {
  ...
  signInText: { ...typography.h3, fontSize: 16, color: colors.onPrimaryContainer },
  ...
  socialBtn: {
    ...
    gap: spacing.sm, paddingVertical: spacing.sm, borderRadius: radii['2xl'],
    borderWidth: 1, borderColor: colors.outlineVariant,
  },
  socialText: { ...typography.bodyMd, color: colors.warmBrown, fontWeight: '600' },
